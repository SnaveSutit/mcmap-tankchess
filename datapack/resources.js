...
class Font {
	...
	static instantiate() {
		...
		new Font('popups')
			.newChar('popup.background_a', 'tankchess:font/gui/vehicle_popups/background_a.png', 64, 128)
			.newChar('popup.background_b', 'tankchess:font/gui/vehicle_popups/background_b.png', 64, 128)
	}
}
